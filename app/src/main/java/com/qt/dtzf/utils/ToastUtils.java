...
public class ToastUtils {
    ...
    public static void Toast_short(String content){
        ...
        if (mToast != null)
            ...
            mToast = Toast.makeText(APP.getmContext(), content, Toast.LENGTH_SHORT);
    ...
    public static void Toast_long(String content){
        ...
        if (mToast != null)
            ...
            mToast = Toast.makeText(APP.getmContext(), content, Toast.LENGTH_LONG);
        mHandler.postDelayed(r, 1000);
